(() => {
  ...
  style.textContent=`
    ...
    .welcome-pledge span{border:2px solid rgba(7,155,152,.16);box-shadow:0 10px 24px rgba(18,61,100,.10)}
    .welcome-pledge b{font-size:1.08rem}.welcome-pledge small{font-size:.82rem}
    ...
    .promise-grid{grid-template-columns:repeat(3,1fr);max-width:1180px}.promise-grid article{min-height:145px}
    .promise-grid b{font-size:1.15rem}.promise-grid p{font-size:1rem}
