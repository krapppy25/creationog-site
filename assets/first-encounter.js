(() => {
  ...
  style.textContent = `
    .site-nav{gap:30px;padding-left:3.5vw;padding-right:3.5vw}
    .site-nav nav{gap:clamp(24px,2.5vw,46px)}
    ...
    .promise-section{position:relative;background:linear-gradient(180deg,#fff4c9 0%,#fffaf0 30%,#eef8ff 100%);overflow:hidden}.promise-section>*{position:relative;z-index:1}
    .promise-copy{max-width:1060px;margin-bottom:52px}.promise-copy .eyebrow{display:inline-block;background:#fff;border:3px solid #ff9e72;border-radius:999px;padding:7px 16px;box-shadow:4px 5px 0 rgba(240,100,35,.14)}
    .promise-copy h2{display:inline-block;position:relative;padding:0 22px 12px;margin-top:18px}.promise-copy h2:after{content:"";position:absolute;left:11%;right:8%;bottom:0;height:9px;background:linear-gradient(90deg,#ffc83d 0 28%,#079b98 28% 58%,#f06423 58% 78%,#7650a5 78%);border-radius:99px;transform:rotate(-1deg)}
    ...
    .promise-grid{grid-template-columns:repeat(3,1fr);max-width:1240px;gap:28px}.promise-grid article{position:relative;min-height:205px;border:4px solid rgba(18,61,100,.10);padding:58px 28px 28px;border-radius:30px;box-shadow:9px 10px 0 rgba(18,61,100,.08);overflow:visible}
    ...
    .promise-bottom img{width:270px;flex:0 0 auto}.promise-bottom b{font-size:1.5rem;margin-bottom:8px}.relationship-line{display:block;font-size:1.12rem!important;line-height:1.45;white-space:nowrap;font-weight:800}

    .clubhouse-section{padding:100px 5vw 80px;background:linear-gradient(155deg,#fff3bd 0%,#fff9e8 32%,#dcf5f1 70%,#e6f2ff 100%);position:relative;overflow:hidden}
    .clubhouse-section:before{content:"";position:absolute;left:-65px;bottom:130px;width:190px;height:190px;border:18px solid rgba(255,126,98,.18);border-radius:50%}
    .clubhouse-heading{max-width:950px;margin:0 auto 52px;text-align:center}.clubhouse-heading .eyebrow{display:inline-block;background:#fff;border:3px solid #f06423;padding:8px 17px;border-radius:999px;box-shadow:5px 6px 0 #ffc83d}
    .clubhouse-heading h2{font-size:clamp(3.2rem,5vw,5.8rem);line-height:.95;letter-spacing:-.05em;margin:.24em 0}.clubhouse-heading>p:last-child{font-size:1.25rem;max-width:70ch;margin:auto}
    .clubhouse-layout{max-width:1450px;margin:auto;display:grid;grid-template-columns:1.08fr .92fr;gap:54px;align-items:start}
    .clubhouse-notes{background:rgba(255,253,246,.70);border:4px dashed rgba(18,61,100,.17);border-radius:34px;padding:30px}.notes-title{display:flex;align-items:center;gap:16px;margin-bottom:26px}.notes-title>span{width:58px;height:58px;display:grid;place-items:center;border-radius:18px;background:#123d64;color:#fff;font-size:2rem;transform:rotate(-6deg)}.notes-title b{display:block;font-size:1.35rem}.notes-title small{display:block;max-width:65ch;line-height:1.35;color:#526b7d}
    .note-wall{display:grid;grid-template-columns:1fr 1fr;gap:24px}.hand-note{margin:0;padding:28px 26px 24px;min-height:180px;border:0;border-radius:5px 18px 8px 15px;box-shadow:8px 10px 0 rgba(18,61,100,.09);font-family:"Comic Sans MS","Bradley Hand",cursive;font-size:1.27rem;line-height:1.38;color:#183f5f;position:relative}.hand-note:before{content:"";position:absolute;top:-10px;left:38%;width:76px;height:22px;background:rgba(255,255,255,.62);transform:rotate(-4deg)}.hand-note span{display:block;margin-top:18px;font-family:"Trebuchet MS",Arial,sans-serif;font-size:.74rem;line-height:1.3;font-weight:900;text-transform:uppercase;letter-spacing:.05em;color:#536b79}
    .hand-note:nth-child(2){transform:rotate(1.4deg)}.hand-note:nth-child(3){transform:rotate(-1.2deg)}.hand-note:nth-child(4){transform:rotate(1deg)}.hand-note:nth-child(5){grid-column:1/-1;max-width:62%;justify-self:center;transform:rotate(-.7deg)}.note-yellow{background:#fff1a9}.note-blue{background:#dceeff}.note-coral{background:#ffdcd0}.note-purple{background:#eee1ff}.note-green{background:#e8f2c9}
    .clubhouse-form-card{background:#fff;border:4px solid #123d64;border-radius:34px;padding:34px;box-shadow:12px 13px 0 #ffc83d;position:sticky;top:120px}.form-kicker{font-weight:1000;letter-spacing:.1em;color:#f06423;margin:0 0 5px}.clubhouse-form-card h3{font-size:2.25rem;line-height:1;margin:.15em 0 .4em}.clubhouse-form-card>p{font-size:1.06rem}.clubhouse-form-card label,.clubhouse-form-card legend{display:block;font-weight:900;margin-top:18px}.clubhouse-form-card label small{font-weight:400}
    .clubhouse-form-card select,.clubhouse-form-card textarea,.clubhouse-form-card input[type=text]{width:100%;margin-top:7px;padding:13px 14px;border:2px solid #bfd1d5;border-radius:14px;background:#fffdf6;color:#123d64;font:inherit}.clubhouse-form-card textarea{resize:vertical}.clubhouse-form-card fieldset{border:2px dashed #b9ccca;border-radius:16px;margin:20px 0;padding:14px 16px}.clubhouse-form-card fieldset label{display:inline-flex;align-items:center;gap:6px;margin:10px 22px 0 0}.clubhouse-send{width:100%;border:0;border-radius:999px;padding:16px 18px;background:#079b98;color:#fff;font-weight:1000;cursor:pointer;box-shadow:5px 6px 0 #f06423}.clubhouse-privacy{font-size:.86rem!important;line-height:1.45;color:#526b7d;margin:18px 0 0}
    .clubhouse-return{max-width:1050px;margin:62px auto 0;text-align:center;background:#123d64;color:#fff;border-radius:28px;padding:26px 30px;box-shadow:8px 9px 0 #ffc83d}.clubhouse-return b{display:block;font-size:1.5rem;color:#ffd34d}.clubhouse-return span{display:block;margin:5px 0 15px}.clubhouse-return a{display:inline-block;color:#fff;font-weight:1000;text-decoration:none;border-bottom:3px solid #079b98}
    footer{font-size:1.03rem}

    @media(max-width:1350px){.site-nav nav{gap:20px}.site-nav nav a{font-size:.98rem}.relationship-line{font-size:1.02rem!important}}
    @media(max-width:1250px){.welcome-threshold{grid-template-columns:1fr;padding-right:5vw}.welcome-art{min-height:auto;margin-top:24px}.creator-place{width:min(900px,96%);margin:auto}.guides-section{grid-template-columns:1fr}.guides-art{min-height:auto}.guides-art img{width:min(820px,96%);margin:auto}.promise-bottom{max-width:1000px}.relationship-line{white-space:normal}.clubhouse-layout{grid-template-columns:1fr}.clubhouse-form-card{position:relative;top:auto;max-width:850px;margin:auto}}
    @media(max-width:900px){.promise-grid{grid-template-columns:1fr 1fr}.promise-bottom{flex-direction:column;text-align:center}.promise-bottom img{width:min(330px,72vw)}.relationship-line{white-space:normal}.review-break{display:none}.welcome-pledge span{min-height:150px}.note-wall{grid-template-columns:1fr 1fr}}
    @media(max-width:620px){.welcome-art{min-height:auto;margin-top:32px}.creator-place{width:100%}.creator-place img{filter:drop-shadow(0 12px 12px rgba(18,61,100,.13))}.guides-art img{width:100%;filter:drop-shadow(0 12px 12px rgba(18,61,100,.11))}.guide-list{grid-template-columns:1fr}.guide-list>span{padding:24px 18px 20px 68px}.promise-grid{grid-template-columns:1fr}.promise-grid article{min-height:0}.human-service-promise{font-size:1.27rem!important;padding:22px 18px}.promise-bottom{padding:22px 18px}.section-intro br{display:none}.clubhouse-section{padding:76px 20px 58px}.clubhouse-layout{gap:34px}.clubhouse-notes,.clubhouse-form-card{padding:22px}.note-wall{grid-template-columns:1fr}.hand-note:nth-child(5){grid-column:auto;max-width:none}.hand-note{min-height:0}.clubhouse-heading h2{font-size:3.4rem}.notes-title{align-items:flex-start}.clubhouse-return{padding:24px 18px}}
  `;
  ...
  const messages = {
    ...
    curious:`<p><strong>Wonder Guide:</strong> You do not need a project to be here.</p><p><strong>Living World Guide:</strong> What is catching your attention right now?</p><p><strong>Experiment Guide:</strong> Follow one thread and see what appears. You can always come back.</p>`
  };
  ...
  if (clubhouseForm) {
    clubhouseForm.addEventListener('submit', e => {
      e.preventDefault();
      const type = document.getElementById('clubhouseType')?.value || 'Just let me write';
      const message = document.getElementById('clubhouseMessage')?.value.trim() || '';
      const name = document.getElementById('clubhouseName')?.value.trim() || 'Anonymous';
      const permission = document.querySelector('input[name="sharePermission"]:checked')?.value || 'No';
      if (!message) {
        document.getElementById('clubhouseMessage')?.focus();
        return;
      }
      const subject = encodeURIComponent('Creation OG Clubhouse Note — Baby Step One');
      const body = encodeURIComponent(`CREATION OG — BABY STEP ONE\nCLUBHOUSE NOTE\n\nType: ${type}\nName / nickname: ${name}\nPermission to share anonymously in the Clubhouse: ${permission}\n\nNOTE:\n${message}\n\n— Sent intentionally from the Creation OG Clubhouse`);
      window.location.href = `mailto:nathan@arcadiafrequencies.com?subject=${subject}&body=${body}`;
    });
  }
})();